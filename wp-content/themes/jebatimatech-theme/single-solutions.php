...
<div <?php generate_do_attr( 'content' ); ?>>
	<main <?php generate_do_attr( 'main' ); ?>>
		...
		<section class="solution-section solution-content has-side-content">
			<div class="section-main-content">
				...
				<div class="content-language">
					<p><?php echo jbati_get_terms_list('pays_origine', get_the_ID()); ?></p>
					<p><?php echo jbati_get_terms_list('langue_du_service', get_the_ID()); ?></p>
				</div>
		...
		<section class="solution-section solution-users jbati-3-columns">
			<h2><?php esc_html_e('Utilisateurs', 'jebatimatech'); ?></h2>
			<p><?php echo jbati_get_terms_list('envergure_clientele_visee', get_the_ID()); ?></p>
			<p><?php echo jbati_get_acf_field_value('moyenne_utilisateur_par_entreprise', get_the_ID()); ?></p>
			<p><?php echo jbati_get_terms_list('categorie_de_clientele', get_the_ID()); ?></p>
			<p><?php echo jbati_get_terms_list('pour_departement', get_the_ID()); ?></p>
			<p><?php echo jbati_get_terms_list('disciplines_construction', get_the_ID()); ?></p>
		</section>

		<section class="solution-section solution-projects">
			<h2><?php esc_html_e('Projets', 'jebatimatech'); ?></h2>
			<p><?php echo jbati_get_terms_list('categorie_de_projet', get_the_ID()); ?></p>
			<p><?php echo jbati_get_terms_list('envergure_de_projets', get_the_ID()); ?></p>
			<p><?php echo jbati_get_terms_list('phases_de_projet', get_the_ID()); ?></p>
		</section>

		<section class="solution-section solution-specifications jbati-3-columns">
			...
			<p><?php echo jbati_get_terms_list('delais_demarrage', get_the_ID()); ?></p>
			<p><?php echo jbati_get_terms_list('import_export', get_the_ID()); ?></p>
		...
		<section class="solution-section solution-functionalities">
			...
			<p><?php echo jbati_get_terms_list('themes', get_the_ID()); ?></p>
		</section>
	</main>
</div>
